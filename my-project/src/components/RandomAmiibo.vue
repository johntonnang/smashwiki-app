<script>
  ...
  export default {
    ...
    methods: {
      getAmiiboList() {
        const randomId =
          this.amiiboDataList.amiibo[
            Math.floor(Math.random() * this.amiiboDataList.amiibo.length)
          ].name
  ...
  <main class="random-page">
    ...
    <div>
      ...
      <div v-if="amiiboDataList">
        <ul>
          <li :key="amiibo[0].character" v-for="amiibo in amiiboRandom">
